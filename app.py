...
from helpers import (
    BASE_DIR, DATA_DIR, UPLOAD_DIR, OUTPUT_DIR, CLIENTS_DIR, PAGES_DIR,
    VERIFY_DIR, JOBS_FILE, DB_PATH, VENDOR_CATEGORIES_FILE,
    jobs, _jobs_lock, _active_procs, load_jobs, save_jobs, _sync_job_to_db,
    VALID_DOC_TYPES, _start_time, _app_version,
    _sanitize_job, _secure_file, _client_dir,
    CHART_OF_ACCOUNTS, ALL_ACCOUNTS,
    _normalize_vendor, _load_vendor_categories, _save_vendor_categories,
    _learn_vendor_category, _suggest_category,
    _load_verifications, _save_verifications, _update_verify_summary, _verify_path,
    _gather_uncategorized, _regen_excel,
)
...
# ─── Health Check ── (moved to routes/health.py) ─────────────────────────────
